    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          {years.map((year) => (
            <div key={year} className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
              ...
              <div className="space-y-3">
                {postsByYear[year].map((post) => (
                  <Link
                    key={post.slug}
                    href={`/post/${post.slug}`}
                    className="block p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors group"
                  >
