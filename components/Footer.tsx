        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/archive" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Архив
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/publications" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Бүтээл
                </a>
              </li>
            </ul>
